    ...
    <main>
        <div class="width-limiter">
            ...
            <section class="block-categories">
                <ul class="clearfix">
                    <li><a href="/<?php echo $lng;?>/prod/cm/jh/prod.php"><img src="/images/index/it1-en.jpg" alt="Most Popular"></a></li>
                    <li><a href=""><img src="/images/index/it2-en.jpg" alt="Kitchen"></a></li>
                    <li><a href=""><img src="/images/index/it3-en.jpg" alt="Home Decor"></a></li>
                    <li><a href=""><img src="/images/index/it4-en.jpg" alt="Stationery"></a></li>
                </ul>
            </section>
                ...
                <div id="jollyheap" class="prod">
                    <div class="intro-bar clearfix">
                        ...
                        <div class="btn-sp btn-video">
                            <a href="#" vid="intro1" type="video" vidsrc='<iframe width="100%" src="https://www.youtube.com/embed/DiRS0OblqeY" frameborder="0" allowfullscreen></iframe>'>INTRO 1</a>
                            <a href="#" vid="intro2" type="video" vidsrc='<iframe width="100%" src="https://www.youtube.com/embed/Yi5gi8pEWWg" frameborder="0" allowfullscreen></iframe>'>INTRO 2</a>
                        </div>
                        <div class="btn-detail"><a href="/<?php echo $lng;?>/prod/cm/jh/prod.php">DETAIL</a></div>
                    </div>
