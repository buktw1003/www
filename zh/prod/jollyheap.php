        ...
        <div class="width-limiter">
            <section class="block-figure clearfix">
                ...
                <div class="text onimg">
                    <h2>JollyHeap - Smart Cube是一款專為孩童設計的益智玩具。</h2>
            ...
            <section class="prod-intro">
                <div class="row-container top">
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            ...
                            <p>不止手眼協調能力、空間建構也是早期孩童教育種點之一。如何在遊戲中促進孩子的想像力及創造力？答案是積木！如何讓孩子在遊戲中發現問題進而培養解決問題的觀念？答案還是積木！Jollyheap Smart cube鼓勵孩子勇於冒險，開發無限可能與想像力。大尺寸布積木Jollyheap Smart cube也是培養社交能力的一大利器！
                            </p>
                        </div>
                        <div class="col-xs-4">
                            <h3>寓教於樂</h3>
                ...
                <div class="row-container">
                    <div class="row">
                        <div class="col-sm-7">
                            <h3>一組積木 多種功能 jollyheap益智布積木組訓練孩子：</h3>
